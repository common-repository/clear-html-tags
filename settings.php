        ...
        <div class="wbs-content option-form" id="optionsframework">
            ...
            <div class="sc-body ">
                <table class="wbs-form-table">
                    ...
                    <tr v-if="false">
                        <th class="row w8em">删除标签内容</th>
                        <td>
                            <input v-model="opt.delete_tag" class="wbs-input" type="text">
                            <div class="description mt">如需删除标签及标签所包括的代码内容，则输入标签名称+all。比如需删除div标签及其包含内容，则输入 &lt;code&gt;div all&lt;/code&gt;。</div>
                        </td>
                    </tr>
                </table>
        ...
        <div class="sc-body ">
            <table>
                <table class="wbs-form-table">
                    <tbody>
                    <tr>
                        <td class="row w8em">替换项目</td>
                        <td>
                            <ul>
                                <li v-for="(r,idx) in opt.txt_replace"><input type="text" v-model="r.s">  替换 <input type="text" v-model="r.r"> <label><input type="checkbox" true-value="1" false-value="0" v-model="r.c">启用</label>  <a href="###" @click="item_remove(idx)"> x </a></li>
                            </ul>
                            <input type="text" placeholder="搜索内容" v-model="new_s"> 替换 <input placeholder="替换内容" type="text" v-model="new_r"> <button type="button" @click="add_item">增加</button>

                            <div class="description mt">使用*代表任意查找字符，括号 (匹配内容)可在替换内容用$1引用。例如：搜索 &lt;div class="post-title"&gt;(*)&lt;/div&gt; 替换为 &lt;h1&gt;$1&lt;/h1&gt; </div>
